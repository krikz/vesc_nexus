...
{
    state_pub_ = node_->create_publisher<vesc_interfaces::msg::VescStateStamped>(
...
void VescDevice::updateState(const vesc_interfaces::msg::VescState &state)
{
    auto msg = std::make_shared<vesc_interfaces::msg::VescStateStamped>();
